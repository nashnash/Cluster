...
class RegistrationController extends AbstractController
{
     ...
     * @return Response
     */
    public function registerProfessional(Request $request, UserPasswordEncoderInterface $passwordEncoder, GuardAuthenticatorHandler $guardHandler, AppAuthenticator $authenticator): Response
    {
        $user = new User();
